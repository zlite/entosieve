...
The advantage of digital control is that it can be monitored and controlled remotely and all settings and run metrics can be recorded as a part of fully digital pipeline in a lab. 
